...
output$checkpoint_reco <- renderUI({
  ...
  output_message <- div(id = "checkpoint_reco",
      "1 checkpoint per week is a good rule of thumb. Based on expected duration,",
      tags$b("we suggest ",
      recommendation,
      "checpoints."
      )
...
Row {data-height=30}
-----------------------------
v3.1 - Thanks for using! For version history, to report bugs and submit feature requests [click here](https://github.com/alphanumerritt/sequential-test-app/issues){target="_blank"}.
